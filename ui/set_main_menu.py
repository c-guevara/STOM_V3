...
class SetMainMenu:
    ...
    def set(self):
        ...
        self.ui.pushButton_00 = self.wc.setPushbutton('', icon=self.ui.icon_home,   color=0, click=self.ui.mnButtonClicked_01, cmd=0, shortcut='Ctrl+1', tip='홈(Ctrl+1)')
        self.ui.pushButton_01 = self.wc.setPushbutton('', icon=self.ui.icon_stock,  color=6, click=self.ui.mnButtonClicked_01, cmd=1, shortcut='Ctrl+2', tip='주식 및 해선 트레이더(Ctrl+2)')
        self.ui.pushButton_02 = self.wc.setPushbutton('', icon=self.ui.icon_coin,   color=6, click=self.ui.mnButtonClicked_01, cmd=2, shortcut='Ctrl+3', tip='업비트 및 바이낸스 트레이더(Ctrl+3)')
        self.ui.pushButton_03 = self.wc.setPushbutton('', icon=self.ui.icon_stocks, color=6, click=self.ui.mnButtonClicked_01, cmd=3, shortcut='Ctrl+4', tip='주식 및 해선 전략(Ctrl+4)')
        self.ui.pushButton_04 = self.wc.setPushbutton('', icon=self.ui.icon_coins,  color=6, click=self.ui.mnButtonClicked_01, cmd=4, shortcut='Ctrl+5', tip='업비트 및 바이낸스 전략(Ctrl+5)')
        self.ui.pushButton_05 = self.wc.setPushbutton('', icon=self.ui.icon_live,   color=6, click=self.ui.mnButtonClicked_01, cmd=5, shortcut='Ctrl+6', tip='스톰 라이브(Ctrl+6)')
        self.ui.pushButton_06 = self.wc.setPushbutton('', icon=self.ui.icon_log,    color=6, click=self.ui.mnButtonClicked_01, cmd=6, shortcut='Ctrl+7', tip='로그(Ctrl+7)')
        self.ui.pushButton_07 = self.wc.setPushbutton('', icon=self.ui.icon_set,    color=6, click=self.ui.mnButtonClicked_01, cmd=7, shortcut='Ctrl+8', tip='설정(Ctrl+8)')
        ...
        self.ui.ds_pushButton = self.wc.setPushbutton('Q', color=6, click=self.ui.ManualSaveAndExit,  shortcut='Shift+S', tip='데이터 저장 및 수동 종료')
        self.ui.od_pushButton = self.wc.setPushbutton('O', color=6, click=self.ui.ShowOrder,          shortcut='Shift+O', tip='수동주문창')
        self.ui.zz_pushButton = self.wc.setPushbutton('E', color=6, click=self.ui.ExtendWindow,       shortcut='Shift+E', tip='전략탭확장')
        ...
        self.ui.kp_pushButton.setGeometry(23, 370, 16, 15)
        self.ui.zo_pushButton.setGeometry(8, 390, 16, 15)
        ...
        self.ui.js_pushButton.setGeometry(23, 430, 16, 15)
        self.ui.qs_pushButton.setGeometry(8, 450, 16, 15)
        self.ui.bs_pushButton.setGeometry(23, 450, 16, 15)
