...
class SetMainMenu:
    ...
    def set(self):
        ...
        self.ui.pushButton_00 = self.wc.setPushbutton('', icon=self.ui.icon_home,   color=0, click=self.ui.mnButtonClicked_01, cmd=0, animated=True, shortcut='Ctrl+1', tip='홈(Ctrl+1)')
        ...
        self.ui.ms_pushButton = self.wc.setPushbutton('S', color=6, click=self.ui.mnButtonClicked_03, shortcut='Alt+S', animated=True, tip='수동시작')
        ...
        self.ui.ds_pushButton = self.wc.setPushbutton('Q', color=6, click=self.ui.ManualSaveAndExit,  shortcut='Shift+S', animated=True, tip='데이터 저장 및 수동 종료')
