...
from ui.ui_cell_clicked import cell_clicked_05
...
class SetStrategyTab:
    ...
    # =================================================================================================================
        ...
        self.ui.svjb_comboBoxx_01 = self.wc.setCombobox(self.ui.st_tab, font=qfont14, activated=lambda: ui_activated_stg.activated_01(self.ui))
        ...
        self.ui.svjs_comboBoxx_01 = self.wc.setCombobox(self.ui.st_tab, font=qfont14, activated=lambda: ui_activated_stg.activated_02(self.ui))
    ...
    # =================================================================================================================
        ...
        self.ui.svc_comboBoxxx_02 = self.wc.setCombobox(self.ui.st_tab, font=qfont14, activated=lambda: ui_activated_stg.activated_04(self.ui))
    ...
    # =================================================================================================================
        ...
        self.ui.svc_comboBoxxx_08 = self.wc.setCombobox(self.ui.st_tab, font=qfont14, activated=lambda: ui_activated_stg.activated_05(self.ui))
    ...
    # =================================================================================================================
        ...
        self.ui.sva_comboBoxxx_01 = self.wc.setCombobox(self.ui.st_tab, font=qfont14, activated=lambda: ui_activated_stg.activated_06(self.ui))
    ...
    # =================================================================================================================
        ...
        self.ui.svo_comboBoxxx_01 = self.wc.setCombobox(self.ui.st_tab, font=qfont14, activated=lambda: ui_activated_stg.activated_07(self.ui))
        ...
        self.ui.svo_comboBoxxx_02 = self.wc.setCombobox(self.ui.st_tab, font=qfont14, activated=lambda: ui_activated_stg.activated_08(self.ui))
