...
class SetStrategyTab:
    ...
    # =================================================================================================================
        ...
        self.ui.ss_tableWidget_01 = self.wc.setTablewidget(self.ui.st_tab, columns_bt, 32, vscroll=True, fixed=True, clicked=lambda row, col: cell_clicked_06(self.ui, row, col))
        self.ui.ss_comboBoxxxx_01 = self.wc.setCombobox(self.ui.st_tab, font=qfont12, activated=lambda: ui_activated_etc.dactivated_01(self.ui))
        ...
        self.ui.ss_comboBoxxxx_02 = self.wc.setCombobox(self.ui.st_tab, font=qfont12, activated=lambda: ui_activated_etc.dactivated_01(self.ui))
        ...
        self.ui.ss_comboBoxxxx_03 = self.wc.setCombobox(self.ui.st_tab, font=qfont12, activated=lambda: ui_activated_etc.dactivated_01(self.ui))
    ...
    # =================================================================================================================
        ...
        self.ui.svjb_comboBoxx_01 = self.wc.setCombobox(self.ui.st_tab, font=qfont14, activated=lambda: ui_activated_stg.activated_01(self.ui, 'stock'))
        ...
        self.ui.svjs_comboBoxx_01 = self.wc.setCombobox(self.ui.st_tab, font=qfont14, activated=lambda: ui_activated_stg.activated_02(self.ui, 'stock'))
    ...
    # =================================================================================================================
        ...
        self.ui.svc_comboBoxxx_01 = self.wc.setCombobox(self.ui.st_tab, font=qfont14, activated=lambda: ui_activated_stg.activated_03(self.ui))
        ...
        self.ui.svc_comboBoxxx_02 = self.wc.setCombobox(self.ui.st_tab, font=qfont14, activated=lambda: ui_activated_stg.activated_04(self.ui, 'stock'))
    ...
    # =================================================================================================================
        ...
        self.ui.svc_comboBoxxx_08 = self.wc.setCombobox(self.ui.st_tab, font=qfont14, activated=lambda: ui_activated_stg.activated_05(self.ui, 'stock'))
        ...
        self.ui.svc_pushButton_11 = self.wc.setPushbutton('예제', parent=self.ui.st_tab, bounced=True, click=lambda: opti_sample, color=3)
    ...
    # =================================================================================================================
        ...
        self.ui.sva_comboBoxxx_01 = self.wc.setCombobox(self.ui.st_tab, font=qfont14, activated=lambda: ui_activated_stg.activated_06(self.ui, 'stock'))
    ...
    # =================================================================================================================
        ...
        self.ui.svo_comboBoxxx_01 = self.wc.setCombobox(self.ui.st_tab, font=qfont14, activated=lambda: ui_activated_stg.activated_07(self.ui, 'stock'))
        ...
        self.ui.svo_comboBoxxx_02 = self.wc.setCombobox(self.ui.st_tab, font=qfont14, activated=lambda: ui_activated_stg.activated_08(self.ui, 'stock'))
        ...
        self.ui.svo_pushButton_08 = self.wc.setPushbutton('예제', parent=self.ui.st_tab, bounced=True, click=lambda: opti_sample, color=3)
