...
class SetDialogEtc:
    ...
    def set(self):
        ...
        self.ui.set_pushButton_01 = self.wc.setPushbutton('설정예제', box=self.ui.dialog_setsj, click=self.ui.SettingStockElapsedTickNumberSample)
        self.ui.set_pushButton_02 = self.wc.setPushbutton('불러오기', box=self.ui.dialog_setsj, click=self.ui.SettingStockElapsedTickNumberLoad)
    ...
    예제에서 사용한 조건명 이평60데드는 경과틱수('이평60데드') 형태로 사용합니다. 반드시 조건명에 따옴표를 붙여야합니다."""
        ...
        self.ui.cet_pushButton_01 = self.wc.setPushbutton('설정예제', box=self.ui.dialog_cetsj, click=self.ui.SettingCoinElapsedTickNumberSample)
        self.ui.cet_pushButton_02 = self.wc.setPushbutton('불러오기', box=self.ui.dialog_cetsj, click=self.ui.SettingCoinElapsedTickNumberLoad)
        self.ui.cet_pushButton_03 = self.wc.setPushbutton('저장하기', box=self.ui.dialog_cetsj, click=self.ui.SettingCoinElapsedTickNumberSave)
