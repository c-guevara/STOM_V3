...
class SetDialogEtc:
    ...
    def set(self):
        ...
        self.ui.hg_pushButtonnn_01 = self.wc.setPushbutton('이전(Alt+left)', parent=self.ui.dialog_hoga, click=self.ui.hgButtonClicked_01, cmd='이전', shortcut='Alt+left')
        self.ui.hg_pushButtonnn_02 = self.wc.setPushbutton('다음(Alt+right)', parent=self.ui.dialog_hoga, click=self.ui.hgButtonClicked_01, cmd='다음', shortcut='Alt+right')
        self.ui.hg_pushButtonnn_03 = self.wc.setPushbutton('매수(Alt+up)', parent=self.ui.dialog_hoga, color=2, click=self.ui.hgButtonClicked_02, cmd='매수', shortcut='Alt+up')
        self.ui.hg_pushButtonnn_04 = self.wc.setPushbutton('매도(Alt+down)', parent=self.ui.dialog_hoga, color=3, click=self.ui.hgButtonClicked_02, cmd='매도', shortcut='Alt+down')
        ...
        self.ui.db_pushButtonnn_18 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_01, click=self.ui.dbButtonClicked_18)
        ...
        self.ui.db_pushButtonnn_01 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_01, click=self.ui.dbButtonClicked_01)
        ...
        self.ui.db_pushButtonnn_02 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_01, click=self.ui.dbButtonClicked_02)
        ...
        self.ui.db_pushButtonnn_03 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_01, click=self.ui.dbButtonClicked_03)
        ...
        self.ui.db_pushButtonnn_04 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_01, click=self.ui.dbButtonClicked_04)
        ...
        self.ui.db_pushButtonnn_05 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_01, click=self.ui.dbButtonClicked_05)
        ...
        self.ui.db_pushButtonnn_06 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_01, click=self.ui.dbButtonClicked_06)
        self.ui.db_labellllllll_07 = QLabel('백테DB에 당일DB의 데이터 추가하기 (추가 후 당일DB는 삭제됨)', self.ui.db_groupBoxxxxx_01)
        self.ui.db_pushButtonnn_07 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_01, click=self.ui.dbButtonClicked_07)
        self.ui.db_labellllllll_08 = QLabel('당일DB를 일자DB로 분리하기', self.ui.db_groupBoxxxxx_01)
        self.ui.db_pushButtonnn_08 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_01, click=self.ui.dbButtonClicked_08)
        self.ui.db_labellllllll_09 = QLabel('거래기록 테이블 모두 삭제 (체결목록, 잔고목록, 거래목록, 일별실현손익)', self.ui.db_groupBoxxxxx_01)
        self.ui.db_pushButtonnn_09 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_01, click=self.ui.dbButtonClicked_09)
        ...
        self.ui.db_pushButtonnn_19 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_02, click=self.ui.dbButtonClicked_19)
        ...
        self.ui.db_pushButtonnn_10 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_02, click=self.ui.dbButtonClicked_10)
        ...
        self.ui.db_pushButtonnn_11 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_02, click=self.ui.dbButtonClicked_11)
        ...
        self.ui.db_pushButtonnn_12 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_02, click=self.ui.dbButtonClicked_12)
        ...
        self.ui.db_pushButtonnn_13 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_02, click=self.ui.dbButtonClicked_13)
        ...
        self.ui.db_pushButtonnn_14 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_02, click=self.ui.dbButtonClicked_14)
        self.ui.db_labellllllll_15 = QLabel('백테DB에 당일DB의 데이터 추가하기 (추가 후 당일DB는 삭제됨)', self.ui.db_groupBoxxxxx_02)
        self.ui.db_pushButtonnn_15 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_02, click=self.ui.dbButtonClicked_15)
        self.ui.db_labellllllll_16 = QLabel('당일DB를 일자DB로 분리하기', self.ui.db_groupBoxxxxx_02)
        self.ui.db_pushButtonnn_16 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_02, click=self.ui.dbButtonClicked_16)
        self.ui.db_labellllllll_17 = QLabel('거래기록 테이블 모두 삭제 (체결목록, 잔고목록, 거래목록, 일별실현손익)', self.ui.db_groupBoxxxxx_02)
        self.ui.db_pushButtonnn_17 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_02, click=self.ui.dbButtonClicked_17)
        ...
        self.ui.od_comboBoxxxxx_01 = self.wc.setCombobox(self.ui.od_groupBoxxxxx_01, activated=self.ui.dActivated_03)
        ...
        self.ui.od_pushButtonnn_01 = self.wc.setPushbutton('매수', parent=self.ui.od_groupBoxxxxx_01, color=2, click=self.ui.odButtonClicked_01)
        self.ui.od_pushButtonnn_02 = self.wc.setPushbutton('매도', parent=self.ui.od_groupBoxxxxx_01, color=3, click=self.ui.odButtonClicked_02)
        self.ui.od_pushButtonnn_03 = self.wc.setPushbutton('BUY_LONG', parent=self.ui.od_groupBoxxxxx_01, color=2, click=self.ui.odButtonClicked_03)
        self.ui.od_pushButtonnn_04 = self.wc.setPushbutton('SELL_LONG', parent=self.ui.od_groupBoxxxxx_01, color=3, click=self.ui.odButtonClicked_04)
        self.ui.od_pushButtonnn_05 = self.wc.setPushbutton('SELL_SHORT', parent=self.ui.od_groupBoxxxxx_01, color=2, click=self.ui.odButtonClicked_05)
        self.ui.od_pushButtonnn_06 = self.wc.setPushbutton('BUY_SHORT', parent=self.ui.od_groupBoxxxxx_01, color=3, click=self.ui.odButtonClicked_06)
        self.ui.od_pushButtonnn_07 = self.wc.setPushbutton('매수취소', parent=self.ui.od_groupBoxxxxx_01, click=self.ui.odButtonClicked_07)
        self.ui.od_pushButtonnn_08 = self.wc.setPushbutton('매도취소', parent=self.ui.od_groupBoxxxxx_01, click=self.ui.odButtonClicked_08)
        ...
        self.ui.op_pushButtonn_01 = self.wc.setPushbutton('OPTUNA DASHBOARD', parent=self.ui.op_groupBoxxxx_01, color=3, click=self.ui.opButtonClicked_01)
        ...
        self.ui.cp_pushButtonn_01 = self.wc.setPushbutton('그래프 비교', parent=self.ui.dialog_comp, click=self.ui.cpButtonClicked_01)
        ...
        self.ui.st_pushButtonn_01 = self.wc.setPushbutton('불러오기', parent=self.ui.dialog_std, click=self.ui.stButtonClicked_01)
        self.ui.st_pushButtonn_02 = self.wc.setPushbutton('저장하기', parent=self.ui.dialog_std, click=self.ui.stButtonClicked_02)
        ...
        self.ui.lv_pushButtonn_01 = self.wc.setPushbutton('불러오기', parent=self.ui.dialog_leverage, click=self.ui.lvButtonClicked_02)
        self.ui.lv_pushButtonn_02 = self.wc.setPushbutton('저장하기', parent=self.ui.dialog_leverage, click=self.ui.lvButtonClicked_03)
        ...
        self.ui.set_pushButton_01 = self.wc.setPushbutton('설정예제', parent=self.ui.dialog_setsj, click=self.ui.SettingStockElapsedTickNumberSample)
        self.ui.set_pushButton_02 = self.wc.setPushbutton('불러오기', parent=self.ui.dialog_setsj, click=self.ui.SettingStockElapsedTickNumberLoad)
        self.ui.set_pushButton_03 = self.wc.setPushbutton('저장하기', parent=self.ui.dialog_setsj, click=self.ui.SettingStockElapsedTickNumberSave)
    ...
    예제에서 사용한 조건명 이평60데드는 경과틱수('이평60데드') 형태로 사용합니다. 반드시 조건명에 따옴표를 붙여야합니다."""
        ...
        self.ui.cet_pushButton_01 = self.wc.setPushbutton('설정예제', parent=self.ui.dialog_cetsj, click=self.ui.SettingCoinElapsedTickNumberSample)
        self.ui.cet_pushButton_02 = self.wc.setPushbutton('불러오기', parent=self.ui.dialog_cetsj, click=self.ui.SettingCoinElapsedTickNumberLoad)
        self.ui.cet_pushButton_03 = self.wc.setPushbutton('저장하기', parent=self.ui.dialog_cetsj, click=self.ui.SettingCoinElapsedTickNumberSave)
