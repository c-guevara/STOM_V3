...
class ImportProgressHook:
    def __init__(self, splash):
        ...
        self.modules = [
            ...
            'ui.set_stg_stock_tap', 'ui.set_dialog_formula', 'ui.set_dialog_strategy', 'ui.ui_draw_chart_db',
            'ui.ui_draw_treemap', 'ui.ui_process_kill', 'ui.ui_load_database', 'ui.ui_extend_window',
            'ui.ui_draw_chart_real', 'ui.ui_update_textedit', 'ui.ui_process_starter', 'utility.webcrawling_homtab'
            ...
            'ui.ui_cell_clicked', 'ui.ui_activated_etc', 'ui.ui_process_alive', 'ui.ui_button_clicked_dialog_formula',
            'ui.ui_activated_back', 'ui.ui_checkbox_changed', 'ui.ui_key_press_event', 'ui.ui_backtest_engine',
            'ui.ui_update_progressbar', 'ui.ui_button_clicked_etc', 'ui.ui_activated_coin_stg',
            'ui.ui_button_clicked_zoom', 'ui.ui_activated_stock_stg', 'ui.ui_button_clicked_order',
            'ui.ui_button_clicked_chart', 'ui.ui_button_clicked_shortcut', 'ui.ui_button_clicked_strategy',
            'ui.ui_button_clicked_settings', 'ui.ui_button_clicked_editer_coin', 'ui.ui_button_clicked_editer_stock',
