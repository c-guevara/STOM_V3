...
class ImportProgressHook:
    def __init__(self, splash):
        ...
        self.modules = [
            ...
            'utility.setting_user', 'utility.webcrawling_homtab', 'utility.database_read_only', 'ui.set_icon',
            ...
            'ui.set_stg_stock_tap', 'ui.set_dialog_formula', 'ui.set_dialog_strategy', 'ui.ui_draw_treemap',
            'ui.ui_draw_chart_db', 'ui.ui_process_kill', 'ui.ui_load_database', 'ui.ui_extend_window',
            ...
            'ui.ui_cell_clicked', 'ui.ui_activated_etc', 'ui.ui_process_alive', 'ui.ui_activated_back',
            'ui.ui_key_press_event', 'ui.ui_backtest_engine', 'ui.ui_checkbox_changed', 'ui.ui_update_progressbar',
            ...
            'ui.ui_button_clicked_dialog_formula', 'ui.ui_button_clicked_editer_ga_coin',
            'ui.ui_button_clicked_editer_backlog', 'ui.ui_button_clicked_dialog_database',
            'ui.ui_button_clicked_editer_ga_stock', 'ui.ui_button_clicked_editer_opti_coin',
            'ui.ui_button_clicked_dialog_backengine', 'ui.ui_button_clicked_editer_opti_stock',
            'ui.ui_button_clicked_editer_stg_buy_coin', 'ui.ui_button_clicked_editer_stg_sell_coin',
            'ui.ui_button_clicked_editer_stg_buy_stock', 'ui.ui_button_clicked_editer_stg_sell_stock',
    ...
    def custom_import(self, name, *args, **kwargs):
        if name in self.modules:
            ...
            progress = self.progress + (self.current_index / self.total_modules) * 79
