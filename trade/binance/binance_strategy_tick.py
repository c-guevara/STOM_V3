...
from utility.static import now, now_utc, dt_ymdhms, get_binance_short_profit, get_binance_long_profit, error_decorator
        ...
        if 데이터길이 >= self.rolling_window:
            ...
            if jg_data:
                ...
                포지션, 매수틱번호, 수익금, 수익률, 레버리지, 매수가, 보유수량, 분할매수횟수, 분할매도횟수, 매수시간, 보유시간, \
                    최고수익률, 최저수익률 = None, 0, 0, 0, 1, 0, 0, 0, 0, now_utc(), 0, 0, 0
