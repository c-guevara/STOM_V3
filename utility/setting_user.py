...
def load_settings():
    ...
    try:
        DICT_SET = {
            ...
            'access_key09': de_text(EN_KEY, df_a['access_key'][9])  if df_a_not_empty and df_a['access_key'][1] else None,
            'secret_key09': de_text(EN_KEY, df_a['secret_key'][9])  if df_a_not_empty and df_a['secret_key'][1] else None,
            'access_key10': de_text(EN_KEY, df_a['access_key'][10]) if df_a_not_empty and df_a['access_key'][2] else None,
            'secret_key10': de_text(EN_KEY, df_a['secret_key'][10]) if df_a_not_empty and df_a['secret_key'][2] else None,
            'access_key11': de_text(EN_KEY, df_a['access_key'][11]) if df_a_not_empty and df_a['access_key'][1] else None,
            'secret_key11': de_text(EN_KEY, df_a['secret_key'][11]) if df_a_not_empty and df_a['secret_key'][1] else None,
            'access_key12': de_text(EN_KEY, df_a['access_key'][12]) if df_a_not_empty and df_a['access_key'][2] else None,
            'secret_key12': de_text(EN_KEY, df_a['secret_key'][12]) if df_a_not_empty and df_a['secret_key'][2] else None,
            'access_key13': de_text(EN_KEY, df_a['access_key'][13]) if df_a_not_empty and df_a['access_key'][1] else None,
            'secret_key13': de_text(EN_KEY, df_a['secret_key'][13]) if df_a_not_empty and df_a['secret_key'][1] else None,
            'access_key14': de_text(EN_KEY, df_a['access_key'][14]) if df_a_not_empty and df_a['access_key'][2] else None,
            'secret_key14': de_text(EN_KEY, df_a['secret_key'][14]) if df_a_not_empty and df_a['secret_key'][2] else None,
            'access_key15': de_text(EN_KEY, df_a['access_key'][15]) if df_a_not_empty and df_a['access_key'][1] else None,
            'secret_key15': de_text(EN_KEY, df_a['secret_key'][15]) if df_a_not_empty and df_a['secret_key'][1] else None,
            'access_key16': de_text(EN_KEY, df_a['access_key'][16]) if df_a_not_empty and df_a['access_key'][2] else None,
            'secret_key16': de_text(EN_KEY, df_a['secret_key'][16]) if df_a_not_empty and df_a['secret_key'][2] else None,
            'access_key17': de_text(EN_KEY, df_a['access_key'][17]) if df_a_not_empty and df_a['access_key'][1] else None,
            'secret_key17': de_text(EN_KEY, df_a['secret_key'][17]) if df_a_not_empty and df_a['secret_key'][1] else None,
            'access_key18': de_text(EN_KEY, df_a['access_key'][18]) if df_a_not_empty and df_a['access_key'][2] else None,
            'secret_key18': de_text(EN_KEY, df_a['secret_key'][18]) if df_a_not_empty and df_a['secret_key'][2] else None,
